...
const myPlants =[
    {plantname:'Lettuce', img:'images/salat.png', description:'Fresh crisp lettuce, grows fast. Easy to grow.', timeToHarvest: 50, phValue: 6.0-7.0, plantType:'leaf'},
    {plantname:'Tomato', img:'images/tomato.png', description:'Tomatoes need much light and like it warm.', timeToHarvest: 150, phValue: 5.5 - 6.5, plantType:'bloom'},
    ...
    {plantname:'Kale', img:'images/kale.png', description:'Very nutritious and healthy, easy to grow', timeToHarvest: 30, phValue: 5.5-6.5, plantType:'leaf'},
    {plantname:'Cucumber', img:'images/cucumber.png', description:'Choose between a huge variety. Likes it sunny and warm', timeToHarvest: 50, phValue: 5.5-6.5, plantType:'bloom'},
    ...
    {plantname:'Bok Choy', img:'images/bokchoi.png', description:'The crunchy chinese cabbage. likes it cool.', timeToHarvest: 50, phValue: 6.0-7.0 , plantType:'leaf'},

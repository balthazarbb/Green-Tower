...
const myPlants = [
  {
    ...
    description: "Fresh crisp lettuce, grows fast. Easy to grow.",
    season: "Spring",
    timeToHarvest: 50,
    phValue: 6.0 - 7.0,
    plantType: "leaf",
  },
  {
    ...
    description: "Tomatoes need much light and like it warm.",
    timeToHarvest: 150,
    phValue: 5.5 - 6.5,
    plantType: "bloom",
  },
  //{plantname:'Radish', img:'', description:'One of the easiest veggies to grow. Don´t forget to eat the green leafs!', timeToHarvest: 45, phValue: 5.5-6.5, plantType:'leaf'},
  {
    plantname: "Kale",
    img: "images/kale.png",
    description: "Very nutritious and healthy, easy to grow",
    timeToHarvest: 30,
    phValue: 5.5 - 6.5,
    plantType: "leaf",
  },
  {
    ...
    description: "Choose between a huge variety. Likes it sunny and warm",
    timeToHarvest: 50,
    phValue: 5.5 - 6.5,
    plantType: "bloom",
  },
  ...
  {
    plantname: "Bok Choy",
    img: "images/bokchoi.png",
    description: "The crunchy chinese cabbage. likes it cool.",
    timeToHarvest: 50,
    phValue: 6.0 - 7.0,
    plantType: "leaf",
  },
  {
    plantname: "Cilantro",
    img: "images/cilantro.png",
    description:
      "Our favourite herb. Can be harvested regularly, needs lots of light",
    timeToHarvest: 25,
    phValue: 6.0,
    plantType: "herb",
  },
  {
    ...
    description:
      "Choose between a huge variety. Needs a lot of light and continues growing when harvested ",
    timeToHarvest: 30,
    phValue: 5.5 - 6.5,
    plantType: "herb",
  },
  {
    plantname: "Mint",
    img: "images/mint.png",
    description: "Choose between a huge variety. Easy to grow.",
    timeToHarvest: 25,
    phValue: 5.5 - 6.5,
    plantType: "herb",
  },
  {
    ...
    description:
      "Make this awesome fruit avalable the whole year. Needs a lot of light",
    timeToHarvest: 30,
    phValue: 6.0,
    plantType: "bloom",
  },
  //{plantname:'Blueberries', img:'', description:'Blueberries are true vitamin bombs. Need a lot of light and likes it warm.', timeToHarvest: 30, phValue: 4.5-5.8, plantType:'bloom'},
  {
    ...
    description: "Hot or sweet, your choice! They like it warm and very sunny.",
    timeToHarvest: 80,
    phValue: 5.5 - 6.0,
    plantType: "veggie",
  },
